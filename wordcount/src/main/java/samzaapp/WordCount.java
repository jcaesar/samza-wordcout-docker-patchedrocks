...
public class WordCount implements StreamApplication {
  ...
  private static final List<String> KAFKA_CONSUMER_ZK_CONNECT = ImmutableList.of("zookeeper1:2181");
  private static final List<String> KAFKA_PRODUCER_BOOTSTRAP_SERVERS = ImmutableList.of("kafka1:9091", "kafka2:9091");
  private static final Map<String, String> KAFKA_DEFAULT_STREAM_CONFIGS = ImmutableMap.of("replication.factor", "2");
